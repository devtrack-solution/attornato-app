...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, SharedModule, TableModule, FreeField2NewComponent, FreeField2EditComponent,
...
export class FreeField2ListComponent implements OnInit {
  ...
  ngOnInit() {
    this.freeField2Service.getFreeField2s(100, 0, true).subscribe((freeField2List: any) => {
