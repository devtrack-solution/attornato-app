...
@Component({
  selector: 'app-local-procedure-new',
  standalone: true,
  imports: [
    CommonModule,
    SharedModule,
  ...
  templateUrl: './local-procedure-new.component.html',
  styleUrl: './local-procedure-new.component.scss'
})
export class LocalProcedureNewComponent implements OnInit {
