...
export class ResponsibleService extends BasicService {
   ...
   */
  getResponsibles(limit: number, offset: number, isActive: boolean = true): Observable<any> {
  ...
  getSearchResponsibles(limit: number, offset: number, isActive: boolean = true, search: any): Observable<any> {
